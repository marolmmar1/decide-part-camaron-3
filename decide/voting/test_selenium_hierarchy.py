...
class VotingHierarchyTestCaseSelenium(StaticLiveServerTestCase):
    ...
    def test_boothVoting(self):
        ...
        dropdown.find_element(By.XPATH, "//option[. = 'Hierarchy']").click()
        ...
        self.driver.find_element(By.ID, "id_options-0-option").send_keys("Opcion")
        self.driver.find_element(By.ID, "id_options-1-number").click()
        self.driver.find_element(By.ID, "id_options-1-number").send_keys("2")
        self.driver.find_element(By.ID, "id_options-1-option").click()
        self.driver.find_element(By.ID, "id_options-1-option").send_keys("Opcion 2")
        self.driver.find_element(By.CSS_SELECTOR, ".column-option").click()
        self.driver.find_element(By.ID, "id_options-0-option").click()
        ...
        dropdown.find_element(By.XPATH, "//option[. = 'Presidente']").click()
        element = self.driver.find_element(By.ID, "id_role")
        actions = ActionChains(self.driver)
        actions.move_to_element(element).click_and_hold().perform()
        element = self.driver.find_element(By.ID, "id_role")
        actions = ActionChains(self.driver)
